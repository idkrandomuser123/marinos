...
ShellRoot {
    ...
    property color colMuted: "#ffffff"
    property color colCyan: "#ffffff"
    property color colPurple: "#ffffff"
    property color colRed: "#ffffff"
    property color colYellow: "#ffffff"
    property color colBlue: "#ffffff"
